class WaitScene extends Phaser.Scene {
    ...
    create()
    {
        ...
        //this.add.image(game.config.width / 2 + 50, (game.config.height / 2) - 100, 'barrilAmarillo').setScale(1);
